                    ...
                    <form method="post" enctype="multipart/form-data" id="formPengabdian">
                        <div class="card-body">
                            <div class="mb-3">
                              ...
                              <select name="kredit_pengajaran_mata_kuliah_id" id="kredit_pengajaran_mata_kuliah_id" class="form-select" required <?= $kredit['status'] !== 'pending' ? 'disabled' : '' ?>>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control" id="tahun_ajaran" name="tahun_ajaran" required value="<?= $kredit['tahun_ajaran'] ?>" <?= $kredit['status'] !== 'pending' ? 'disabled' : '' ?>>
                            </div>

                            <div class="mb-3">
                                <label for="type" class="form-label">Tipe</label>
                                <select class="form-select" id="type" name="type" required <?= $kredit['status'] !== 'pending' ? 'disabled' : '' ?>>
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="semester" name="semester" required <?= $kredit['status'] !== 'pending' ? 'disabled' : '' ?>>
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="kelompok" name="kelompok" <?= $kredit['status'] !== 'pending' ? 'disabled' : '' ?>>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control" id="sks" name="sks" required value="<?= $kredit['sks'] ?>" <?= $kredit['status'] !== 'pending' ? 'disabled' : '' ?>>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                <label for="archive" class="form-label">Ubah Keterangan/Bukti Berkas ( Docx, Pdf, Png, Jpeg )</label>
                                <input type="file" accept="application/vnd.openxmlformats-officedocument.wordprocessingml.document,application/pdf,image/png,image/jpeg" class="form-control" id="archive" name="archive" <?= $kredit['status'] !== 'pending' ? 'disabled' : '' ?>>
                            </div>

                            <?php if($kredit['status'] !== 'pending'): ?>
                                <div class="mb-3">
                                    <label for="keterangan" class="form-label">Keterangan</label>
                                    <textarea class="form-control" id="keterangan" disabled><?= $kredit['keterangan'] ?></textarea>
                                </div>
                            <?php endif ?>
                        </div>

                        <div class="card-footer">
                            <button type="submit" class="btn btn-primary" <?= $kredit['status'] !== 'pending' ? 'disabled' : '' ?>>Simpan</button>
                            <a href="/dosen/pengajaran" class="btn btn-secondary">Kembali</a>
                        </div>
                    </form>
