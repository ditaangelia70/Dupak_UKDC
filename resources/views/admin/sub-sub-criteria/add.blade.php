<div class="app-content-header"> <!--begin::Container-->
    <div class="container-fluid"> <!--begin::Row-->
        <div class="row">
            <div class="col-sm-6">
                <h3 class="mb-3">Sub Sub Kriteria Baru</h3>
            </div>
        </div> <!--end::Row-->
    </div> <!--end::Container-->
                ...
                <div class="card card-primary card-outline mb-4" style="box-shadow:none;border-top: 3px solid #ff5733;"> <!--begin::Header-->
                    ...
                    <form method="post" enctype="multipart/form-data"> <!--begin::Body-->
                        <div class="card-body">
                            ...
                            <div class="mb-3"> <label for="unit" class="form-label">Satuan</label> <input type="text" class="form-control" id="unit" aria-describedby="emailHelp" name="unit" required>
                            </div>
                            <div class="mb-3"> <label for="credit" class="form-label">Kredit Umum</label> <input type="number" class="form-control" id="credit" aria-describedby="emailHelp" name="credit" required step="0.1">
                            </div>
