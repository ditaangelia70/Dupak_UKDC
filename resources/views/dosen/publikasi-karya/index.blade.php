            ...
            <div class="col-lg-12 col-12 connectedSortable">
                <div class="card mb-4" style="box-shadow:none;">
                    <div class="p-3 d-flex justify-content-between align-items-center" style="border-bottom:1px solid gainsboro;">
                        ...
                        <a href="/dosen/publikasi-karya?t=add">
                            <button class="btn btn-primary" style="background:#30645b;border-color:#30645b;"><i class="bi bi-plus"></i> Publikasi Baru</button>
                        </a>
                    </div>
                    <div class="card-body">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex gap-2">
                                            <a href="/dosen/publikasi-karya?t=edit&id=<?= $item['id'] ?>">
                                                <button class="btn btn-primary">
                                                    <i class="bi <?= $item['status'] === 'pending' ? 'bi-pen' : 'bi-eye' ?>"></i>
                                                </button>
                                            </a>
                                            <a href="/dosen/publikasi-karya?t=delete&id=<?= $item['id'] ?>">
