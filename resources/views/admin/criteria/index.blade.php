<div class="app-content-header"> <!--begin::Container-->
    <div class="container-fluid"> <!--begin::Row-->
        <div class="row">
            <div class="col-sm-6">
                <h3 class="mb-3">Master Kriteria</h3>
            </div>
        </div> <!--end::Row-->
    </div> <!--end::Container-->
            ...
            <div class="col-lg-12 col-12 connectedSortable">
                <div class="card mb-4" style="box-shadow:none;">
                    <div class="p-3 d-flex justify-content-between align-items-center" style="border-bottom:1px solid gainsboro;">
                        ...
                        <a href="/admin/criteria?t=add">
                            <button class="btn btn-primary" style="background:#30645b;border-color:#30645b;"><i class="bi bi-plus"></i> Kriteria Baru</button>
                        </a>
                    </div>
                    <div class="card-body">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex gap-2">
                                            <a href="/admin/criteria?t=edit&id=<?= $item['id'] ?>">
                                                <button class="btn btn-secondary">
                                                    <i class="bi bi-pen"></i>
                                                </button>
                                            </a>
                                            <a href="/admin/criteria?t=delete&id=<?= $item['id'] ?>">
