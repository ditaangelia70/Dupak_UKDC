<div class="app-content-header"> <!--begin::Container-->
    <div class="container-fluid"> <!--begin::Row-->
        <div class="row">
            <div class="col-sm-6">
                <h3 class="mb-3">Pengajaran Baru</h3>
            </div>
        </div> <!--end::Row-->
    </div> <!--end::Container-->
                    ...
                    <form method="post" enctype="multipart/form-data" id="formPengabdian">
                        <div class="card-body">
                            <div class="mb-3">
                              ...
                              <select name="kredit_pengajaran_mata_kuliah_id" id="kredit_pengajaran_mata_kuliah_id" class="form-select" required>
                                <option value="">Pilih Mata Kuliah</option>
                                <?php foreach($kredit_pengajaran_mata_kuliah as $k): ?>
                                <option value="<?= $k['id'] ?>"><?= $k['name'] ?> ( <?= $k['credit'] ?> point/sks )</option>
                                <?php endforeach ?>
                              </select>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="type" name="type" required>
                                    ...
                                    <option value="10 SKS Pertama">10 SKS Pertama</option>
                                    <option value="2 SKS Berikutnya">2 SKS Berikutnya</option>
                                </select>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="file" accept="application/vnd.openxmlformats-officedocument.wordprocessingml.document,application/pdf,image/png,image/jpeg" class="form-control" id="archive" name="archive" required>
                            </div>
                        </div>
