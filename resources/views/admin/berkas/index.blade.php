            ...
            <div class="col-lg-12 col-12 connectedSortable">
                <div class="card card-primary card-outline mb-4" style="box-shadow:none;border-top: 3px solid #ff5733;"> <!--begin::Header-->
                    ...
                    <form method="post" enctype="multipart/form-data"> <!--begin::Body-->
                        ...
                        <div class="card-footer"> <button type="submit" class="btn btn-primary" style="background:#30645b;border-color:#30645b;">Simpan</button>                            <a type="submit" class="btn btn-secondary" href="/admin/appointment?id=<?= $_GET['userId'] ?>">Kembali</a> </div> <!--end::Footer-->
                    </form> <!--end::Form-->
