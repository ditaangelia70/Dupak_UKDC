                ...
                <div class="card card-primary card-outline mb-4" style="box-shadow:none;border-top: 3px solid #ff5733;"> <!--begin::Header-->
                    ...
                    <form method="post" enctype="multipart/form-data"> <!--begin::Body-->
                        <div class="card-body">
                            ...
                            <div class="mb-3"> <label for="credit" class="form-label">Kredit Jabatan</label> <input type="number" class="form-control" id="credit" aria-describedby="emailHelp" name="credit" required step="0.1">
                            </div>
...
<script type="text/javascript">
    ...
    const generateSubSubCriteria = (value)=>{
