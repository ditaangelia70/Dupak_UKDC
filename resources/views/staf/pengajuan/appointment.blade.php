                                                ...
                                                foreach($item['sub_criteria'] as $jtem): 
                                                    if(isset($jtem['sub_sub_criteria']) && count($jtem['sub_sub_criteria']) > 0): 
                                                        ...
                                                        <?php foreach($jtem['sub_sub_criteria'] as $kndex => $ktem): ?>
                                                            ...
                                                            <?php if(count($ktem['archives']) > 0): ?>
                                                                <a style="text-decoration: none;" href="/staf/catatan-berkas?id=<?= $ktem['archives'][count($ktem['archives']) - 1]['id'] ?>&old_id=<?= $_GET['id'] ?>">
                                                ...
                                                foreach($item['sub_criteria'] as $jtem): 
                                                    if(isset($jtem['sub_sub_criteria']) && count($jtem['sub_sub_criteria']) > 0): 
                                                        ...
                                                        <?php foreach($jtem['sub_sub_criteria'] as $kndex => $ktem): ?>
                                                            ...
                                                            <a style="text-decoration: none;" href="/staf/<?= $item['name'] === 'Penelitian' ? 'publikasi-karya' : 'pengabdian' ?>">
                                                                <button class="btn btn-primary btn-sm">
                                                                    <i class="bi bi-eye"></i> Cek Publikasi
                                                                </button>
                                                            </a>
                                                            <?php else: ?>
                                                            <a style="text-decoration: none;" href="/staf/upload-berkas?id=<?= $ktem['id'] ?>&userId=<?= $_GET['id'] ?>">
                                                                <button class="btn btn-primary btn-sm">
                                                ...
                                                foreach($item['sub_criteria'] as $jtem): 
                                                    if(isset($jtem['sub_sub_criteria']) && count($jtem['sub_sub_criteria']) > 0): 
                                                        ...
                                                        <?php foreach($jtem['sub_sub_criteria'] as $kndex => $ktem): ?>
                                                            ...
                                                            <?php elseif($item['name'] === 'Penelitian' || $item['name'] === 'Pengabdian'): ?>
                                                            <div class="w-full mb-1">
                                                            <button class="btn btn-primary btn-sm" 
                                                                    onclick="spesial_update(<?= $ktem['id'] ?>, <?= $akun->id ?>)" 
                                                                    style="background: #31cb31 !important;border-color: #25a725 !important;">
                                                                <i class="bi bi-check-lg"></i> Update Point
                                                            </button>
                                                            </div>
                                                            <?php else: ?>
                                                                <div>-</div>
...
<script type="text/javascript">
    const spesial_update = (sub_id,akun_id)=>{
        const value = Number(document.querySelector('.value_sb_'+sub_id).innerText);
        $.ajax({
            url: '/staf/special-update-status',
            method: 'POST',
            data: {
                akun_id,
                value,
