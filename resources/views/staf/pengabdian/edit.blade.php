                    ...
                    <form method="post" enctype="multipart/form-data" id="formPengabdian">
                        <div class="card-body">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="dosen" value="<?= $pengabdian['user']['name'] ?>" readonly>
                            </div>
                            <div class="mb-3">
                                <label for="nip_nidn" class="form-label">NIP/NIDN</label>
                                <input type="text" class="form-control" id="nip_nidn" value="<?= $pengabdian['user']['username'] ?>" readonly>
                            </div>
                            <div class="mb-3">
                                ...
                                <option value="<?= $kg['id'] ?>" <?= $pengabdian['kategori_kegiatan'] === $kg['id'] ? 'selected' : '' ?>><?= $kg['name'] ?> ( <?= $kg['credit'] ?> point )</option>
                                <?php endforeach ?>
                              </select>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" name="status" id="status">
                                    ...
                                    <option value="pending" <?= $pengabdian['status'] === 'pending' ? 'selected' : '' ?>>Pending</option>
                                    <option value="rejected" <?= $pengabdian['status'] === 'rejected' ? 'selected' : '' ?>>Rejected</option>
                                    <option value="approved" <?= $pengabdian['status'] === 'approved' ? 'selected' : '' ?>>Approved</option>
                                </select>
                            </div>
                            <div class="mb-3"> <label for="notes" class="form-label">Catatan Reviewer</label> <textarea type="text" class="form-control" name="review_notes" id="notes" aria-describedby="emailHelp"><?= !isset($pengabdian['review_notes']) || $pengabdian['review_notes'] === '' ? '-' : $pengabdian['review_notes'] ?></textarea>
                            </div>
                        </div>

                        <div class="card-footer">
                            <button type="submit" class="btn btn-primary">Simpan</button>
                            <a href="/staf/pengabdian" class="btn btn-secondary">Kembali</a>
                        </div>
                    </form>
